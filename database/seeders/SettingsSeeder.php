...
class SettingsSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $settings = [
            ...
            [
                'key' => 'default_locale',
                'value' => config('localization.default', 'en'),
                'type' => 'text',
                'group' => 'localization',
                'label' => 'Default Language',
                'description' => 'Default platform locale. Managed by the Localization Center.',
                'is_public' => true,
            ],
            [
                ...
                'description' => 'Default timezone selected during installation.',
                'is_public' => true,
            ],
            [
                ...
                'description' => 'Default account currency for new installations.',
                'is_public' => true,
            ],
            [
            ...
            [
                ...
                'description' => 'Secondary accent available to branded gradients and supporting UI surfaces.',
                'is_public' => true,
            ],
            [
                'key' => 'site_logo',
