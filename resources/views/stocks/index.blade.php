            ...
            <div class="relative z-10">
                <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between">
                    <div class="mb-4 lg:mb-0 lg:flex-1">
                        ...
                        <p class="text-tesla-100 dark:text-gray-300 text-sm">Discover and trade stocks from leading companies</p>
                    ...
                    <div class="bg-card bg-opacity-15 backdrop-blur-xl rounded-xl p-4 border border-white border-opacity-20 shadow-xl lg:w-80">
                        ...
                        <div class="flex space-x-4 text-xs">
                            <div class="flex-1 text-center">
                                ...
                                <p class="text-white font-medium">{{ $gainers->count() }}</p>
                            </div>
                            <div class="flex-1 text-center">
                                <p class="text-tesla-100 dark:text-gray-300">Losers</p>
                                <p class="text-white font-medium">{{ $losers->count() }}</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6" data-market-section="overview">
            ...
            <a href="{{ route('stocks.most-active') }}" class="block bg-card rounded-xl p-4 shadow-sm border border-gray-100 hover:shadow-md hover:border-tesla-200 dark:hover:border-tesla-500 transition-all duration-200 group cursor-pointer" data-market-section="most-active">
                <div class="flex items-center justify-between mb-3">
                    ...
                    <div class="w-8 h-8 flex items-center justify-center">
                        <i data-lucide="activity" class="w-4 h-4 text-tesla-600 group-hover:scale-110 transition-transform duration-200"></i>
                    </div>
                </div>
            </a>
        </div>
                        ...
                        <tbody class="bg-card divide-y divide-gray-100 dark:divide-tesla-600">
                            ...
                            <tr class="hover:bg-muted/30 transition-colors duration-200 stock-row" data-stock-symbol="{{ $stock->symbol }}">
                                ...
                                <td class="px-6 py-4">
                                    ...
                                    <div class="text-xs {{ $stock->change_color }} stock-change" data-stock-change="{{ $stock->symbol }}">
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex space-x-2">
                                        ...
                                        <a href="{{ route('trading.buy', $stock) }}" 
                                        ...
                                        @if(auth()->check())
                                            ...
                                            @endphp
                                            @if($isInWatchlist)
                                                <form action="{{ route('trading.watchlist.remove', $stock) }}" method="POST" class="inline">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit" 
                                            ...
                                            @else
                                                <form action="{{ route('trading.watchlist.add', $stock) }}" method="POST" class="inline">
                                                    @csrf
                                                    <button type="submit" 
