        ...
        <div class="bg-card rounded-xl shadow-sm border border-gray-100 overflow-hidden">
            <div class="px-6 py-4 border-b border-border">
                <div class="flex items-center justify-between">
                    <div>
                        <h3 class="text-lg font-light text-foreground mb-1">Top Losers</h3>
                        <p class="text-xs text-muted-foreground dark:text-gray-300">Stocks with the highest percentage losses</p>
                    </div>
                </div>
            </div>
            ...
            @else
                <div class="text-center py-12">
                    <div class="w-16 h-16 bg-muted rounded-full flex items-center justify-center mx-auto mb-4">
                        <i data-lucide="trending-down" class="w-8 h-8 text-gray-400 dark:text-gray-300"></i>
                    </div>
                    <h3 class="text-lg font-light text-foreground mb-2">No losers found</h3>
                    <p class="text-muted-foreground text-sm mb-4">No stocks with negative losses at the moment</p>
