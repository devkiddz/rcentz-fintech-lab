            ...
            <div class="relative z-10">
                <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between">
                    <div class="mb-4 lg:mb-0 lg:flex-1">
                        <h1 class="text-xl font-light mb-1">Most Active Stocks</h1>
                        <p class="text-tesla-200 text-sm">Stocks with the highest trading volume today</p>
                    </div>
                    ...
                    <div class="bg-white bg-opacity-15 backdrop-blur-xl rounded-xl p-4 border border-white border-opacity-20 shadow-xl lg:w-80">
                        <div class="flex items-center justify-between mb-3">
                            <div>
                                ...
                                <p class="text-lg font-light">{{ $stocks->first() ? $stocks->first()->formatted_volume : '0' }}</p>
                            </div>
                        ...
                        <div class="flex space-x-4 text-xs">
                            <div class="flex-1 text-center">
                                <p class="text-tesla-200">Average</p>
                                <p class="text-white font-medium">{{ number_format($stocks->avg('volume'), 0) }}</p>
                            </div>
                            <div class="flex-1 text-center">
                                <p class="text-tesla-200">Count</p>
                            ...
                            <tr class="hover:bg-gray-50 transition-colors duration-200">
                                <td class="px-6 py-4">
                                    <div class="flex items-center">
                                        @if($index < 3)
                                            <div class="w-6 h-6 bg-tesla-100 rounded-full flex items-center justify-center mr-2">
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex items-center">
                                        <div class="flex-shrink-0 w-8 h-8 rounded-lg overflow-hidden">
                                            ...
                                            @else
                                                <div class="w-8 h-8 bg-tesla-100 rounded-lg flex items-center justify-center">
                                                    <i data-lucide="activity" class="w-4 h-4 text-tesla-600"></i>
                                                </div>
                                            @endif
                                        </div>
                                        <div class="ml-3">
