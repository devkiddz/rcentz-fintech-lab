        ...
        <div class="bg-card rounded-xl shadow-sm border border-gray-100 overflow-hidden">
            <div class="px-6 py-4 border-b border-border">
                <div class="flex items-center justify-between">
                    <div>
                        <h3 class="text-lg font-light text-black dark:text-white mb-1">Top Gainers</h3>
                        <p class="text-xs text-gray-500 dark:text-gray-300">Stocks with the highest percentage gains</p>
                    </div>
                </div>
            </div>
            ...
            @else
                <div class="text-center py-12">
                    ...
                    <h3 class="text-lg font-light text-black dark:text-white mb-2">No gainers found</h3>
                    <p class="text-gray-600 text-sm mb-4">No stocks with positive gains at the moment</p>
