    ...
    <div class="max-w-7xl mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
            ...
            <div class="bg-card rounded-xl p-4 shadow-sm border border-border">
                <div class="flex items-center justify-between mb-3">
                    <div>
                        <p class="text-xs text-muted-foreground dark:text-gray-300 mb-1">Monthly Performance</p>
                        ...
                        <p class="text-xs text-muted-foreground dark:text-gray-300">This month</p>
                    </div>
                    <div class="w-8 h-8 flex items-center justify-center">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
            ...
            <div class="bg-card rounded-xl p-6 shadow-sm border border-border">
                <div class="flex items-center justify-between mb-4">
                    <div>
                        <h3 class="text-lg font-light text-foreground mb-1">Investment Holdings</h3>
                        <p class="text-xs text-muted-foreground dark:text-gray-300">{{ $investmentHoldings->count() }} plans</p>
                    </div>
                        ...
                        <div class="flex items-center justify-between p-3 bg-muted rounded-lg">
                            <div class="flex items-center space-x-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-xs text-muted-foreground dark:text-gray-300">{{ number_format($holding->units, 4) }} units</p>
                                </div>
                            </div>
                ...
                @else
                    <div class="text-center py-6">
                        ...
                        <p class="text-xs text-muted-foreground dark:text-gray-300">No investment holdings</p>
                    </div>
                @endif
            </div>
            ...
            <div class="bg-card rounded-xl p-6 shadow-sm border border-border">
                <div class="flex items-center justify-between mb-4">
                    <div>
                        <h3 class="text-lg font-light text-foreground mb-1">Stock Holdings</h3>
                        <p class="text-xs text-muted-foreground dark:text-gray-300">{{ $stockHoldings->count() }} stocks</p>
                    </div>
                ...
                @else
                    <div class="text-center py-6">
                        ...
                        <p class="text-xs text-muted-foreground dark:text-gray-300">No stock holdings</p>
                    </div>
                @endif
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
            ...
            <div class="bg-card rounded-xl p-6 shadow-sm border border-border">
                <div class="flex items-center justify-between mb-4">
                    <div>
                        <h3 class="text-lg font-light text-foreground mb-1">Recent Investment Activity</h3>
                        <p class="text-xs text-muted-foreground dark:text-gray-300">Latest investment transactions</p>
                    </div>
                ...
                @else
                    <div class="text-center py-6">
                        ...
                        <p class="text-xs text-muted-foreground dark:text-gray-300">No recent investment activity</p>
                    </div>
                @endif
            </div>
            ...
            <div class="bg-card rounded-xl p-6 shadow-sm border border-border">
                <div class="flex items-center justify-between mb-4">
                    <div>
                        <h3 class="text-lg font-light text-foreground mb-1">Recent Stock Activity</h3>
                        <p class="text-xs text-muted-foreground dark:text-gray-300">Latest stock transactions</p>
                    </div>
                ...
                @if($recentStockTransactions->count() > 0)
                    <div class="space-y-3">
                        ...
                        <div class="flex items-center space-x-3 p-3 bg-muted rounded-lg">
                            ...
                            <div class="flex-1 min-w-0">
                                <p class="text-xs font-medium text-foreground">{{ $transaction->stock->symbol }}</p>
                                <p class="text-xs text-muted-foreground dark:text-gray-300">{{ $transaction->type_label }} • {{ $transaction->created_at->format('M j, Y') }}</p>
                            </div>
                            <div class="text-right">
                                <p class="text-xs font-medium text-foreground">{{ currency_symbol() }}{{ number_format($transaction->total_amount, 2) }}</p>
                ...
                @else
                    <div class="text-center py-6">
                        ...
                        <p class="text-xs text-muted-foreground dark:text-gray-300">No recent stock activity</p>
                    </div>
                @endif
            </div>
        </div>
        ...
        <div class="bg-card rounded-xl p-6 shadow-sm border border-border">
            <div class="flex items-center justify-between mb-4">
                <div>
                    <h3 class="text-lg font-light text-foreground mb-1">Automatic Investment Plans</h3>
                    <p class="text-xs text-muted-foreground dark:text-gray-300">Your recurring investment schedules</p>
                </div>
                ...
                <div class="space-y-3">
                    ...
                    <div class="flex items-center justify-between p-3 bg-muted rounded-lg">
                        <div class="flex items-center space-x-3">
                            ...
                            <div>
                                <p class="text-sm font-medium text-foreground">{{ $plan->investmentPlan->name }}</p>
                                <p class="text-xs text-muted-foreground dark:text-gray-300">{{ currency_symbol() }}{{ number_format($plan->amount, 2) }} {{ $plan->frequency }}</p>
                            </div>
                        </div>
                        <div class="text-right">
            ...
            @else
                <div class="text-center py-6">
                    ...
                    <p class="text-xs text-muted-foreground dark:text-gray-300">No automatic investment plans</p>
                    <a href="{{ route('automatic-investments.index') }}" class="inline-flex items-center px-3 py-1 mt-2 bg-foreground text-background text-xs font-medium rounded-lg hover:opacity-90 transition-colors duration-200">
