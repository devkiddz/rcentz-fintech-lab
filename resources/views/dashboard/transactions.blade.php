    ...
    <div class="max-w-7xl mx-auto">
        ...
        <div class="bg-card rounded-xl p-4 shadow-sm border border-gray-100 mb-6">
            <form method="GET" class="grid grid-cols-1 md:grid-cols-5 gap-4">
                ...
                <!-- Asset Type Filter -->
                <div>
                    <label for="asset_type" class="block text-xs font-medium text-foreground mb-1">Asset Type</label>
                    <select id="asset_type" name="asset_type" class="w-full px-3 py-2 border border-border rounded-lg focus:ring-2 focus:ring-ring focus:border-transparent transition-colors duration-200">
                ...
                <div class="flex items-end space-x-2">
                    ...
                    <a href="{{ route('investment.transactions') }}" class="px-4 py-2 border border-border text-foreground text-xs font-medium rounded-lg hover:bg-muted/30 transition-colors duration-200">
        ...
        <div class="bg-card rounded-xl shadow-sm border border-gray-100 overflow-hidden">
            <div class="px-6 py-4 border-b border-border">
                <div class="flex items-center justify-between">
                    <div>
                        <h3 class="text-lg font-light text-foreground mb-1">All Transactions</h3>
                        <p class="text-xs text-muted-foreground dark:text-gray-300">Investment and stock transaction history</p>
                    </div>
                </div>
            </div>
            ...
            @if($allTransactions->count() > 0)
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        <div class="ml-3">
                                            ...
                                            @elseif(isset($transaction->stock))
                                                ...
                                                <div class="text-xs text-muted-foreground dark:text-gray-300">{{ $transaction->stock->name }}</div>
                                            @endif
                                        </div>
                                    </div>
                                </td>
                ...
                <div class="px-6 py-4 border-t border-border">
                    ...
                    <div class="text-center text-xs text-muted-foreground dark:text-gray-300">
            ...
            @else
                <div class="text-center py-12">
                    ...
                    <div class="flex space-x-2 justify-center">
                        ...
                        <a href="{{ route('stocks.index') }}" class="inline-flex items-center px-4 py-2 border border-border text-foreground text-sm font-medium rounded-lg hover:bg-muted/30 transition-colors duration-200">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mt-6">
            ...
            <div class="bg-card rounded-xl p-4 shadow-sm border border-border">
                <div class="flex items-center justify-between mb-3">
                    <div>
                        <p class="text-xs text-muted-foreground dark:text-gray-300 mb-1">Investment Transactions</p>
                        <p class="text-lg font-light text-foreground">{{ $investmentTransactions->total() }}</p>
                    </div>
            ...
            <div class="bg-card rounded-xl p-4 shadow-sm border border-border">
                <div class="flex items-center justify-between mb-3">
                    <div>
                        <p class="text-xs text-muted-foreground dark:text-gray-300 mb-1">Stock Transactions</p>
                        <p class="text-lg font-light text-foreground">{{ $stockTransactions->total() }}</p>
                    </div>
                    <div class="w-8 h-8 flex items-center justify-center">
            ...
            <div class="bg-card rounded-xl p-4 shadow-sm border border-border">
                <div class="flex items-center justify-between mb-3">
                    <div>
                        ...
                        <p class="text-lg font-light text-foreground">{{ currency_symbol() }}{{ number_format($investmentTransactions->sum('total_amount') + $stockTransactions->sum('total_amount'), 2) }}</p>
                    </div>
                    <div class="w-8 h-8 flex items-center justify-center">
            ...
            <div class="bg-card rounded-xl p-4 shadow-sm border border-border">
                <div class="flex items-center justify-between mb-3">
                    <div>
                        ...
                        <p class="text-lg font-light text-foreground">{{ currency_symbol() }}{{ number_format($investmentTransactions->sum('fee') + $stockTransactions->sum('fee'), 2) }}</p>
                    </div>
                    <div class="w-8 h-8 flex items-center justify-center">
