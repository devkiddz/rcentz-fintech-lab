        ...
        <div class="bg-card rounded-xl p-4 shadow-sm border border-gray-100 mb-6">
            <form method="GET" class="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <div class="flex items-end space-x-2">
                    ...
                    <a href="{{ route('portfolio.transactions') }}" class="px-4 py-2 border border-gray-300 text-black text-xs font-medium rounded-lg hover:bg-gray-50 transition-colors duration-200">
        ...
        <div class="bg-card rounded-xl shadow-sm border border-gray-100 overflow-hidden">
            <div class="px-6 py-4 border-b border-border">
                <div class="flex items-center justify-between">
                    <div>
                        <h3 class="text-lg font-light text-black dark:text-white mb-1">Investment Transactions</h3>
                        <p class="text-xs text-gray-500 dark:text-gray-300">Detailed history of your investment activity</p>
                    </div>
                </div>
            </div>
                    ...
                    <table class="w-full">
                        ...
                        <tbody class="bg-card divide-y divide-gray-100 dark:divide-tesla-600">
                            ...
                            <tr class="hover:bg-gray-50 transition-colors duration-200">
                                ...
                                <td class="px-6 py-4">
                                    <div class="text-sm text-black">{{ number_format($transaction->units, 4) }}</div>
                                </td>
                                <td class="px-6 py-4">
                                    <div class="text-sm text-black">{{ currency_symbol() }}{{ number_format($transaction->nav_at_transaction, 4) }}</div>
                                </td>
                                <td class="px-6 py-4">
