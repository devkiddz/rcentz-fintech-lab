    ...
    <div class="max-w-7xl mx-auto">
        ...
        <div class="bg-card rounded-xl p-4 shadow-sm border border-gray-100 mb-6">
            <form method="GET" class="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <div class="flex items-end space-x-2">
                    ...
                    <a href="{{ route('trading.transactions') }}" class="px-4 py-2 border border-gray-300 text-black text-xs font-medium rounded-lg hover:bg-gray-50 transition-colors duration-200">
        ...
        <div class="bg-card rounded-xl shadow-sm border border-gray-100 overflow-hidden">
            <div class="px-6 py-4 border-b border-border">
                <div class="flex items-center justify-between">
                    <div>
                        <h3 class="text-lg font-light text-black dark:text-white mb-1">Stock Transactions</h3>
                        <p class="text-xs text-gray-500 dark:text-gray-300">Detailed history of your stock trading activity</p>
                    </div>
                </div>
            </div>
                    ...
                    <table class="w-full">
                        ...
                        <tbody class="bg-card divide-y divide-gray-100 dark:divide-tesla-600">
                            ...
                            <tr class="hover:bg-gray-50 transition-colors duration-200">
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex items-center">
                                        ...
                                        <div class="ml-3">
                                            ...
                                            <div class="text-xs text-gray-500 dark:text-gray-300">{{ $transaction->stock->company_name }}</div>
                                        </div>
                                    </div>
                                </td>
                                <td class="px-6 py-4">
                                ...
                                <td class="px-6 py-4">
                                    <div class="text-sm text-black">{{ number_format($transaction->shares, 2) }}</div>
                                </td>
                                <td class="px-6 py-4">
                                    <div class="text-sm text-black">{{ currency_symbol() }}{{ number_format($transaction->price_per_share, 2) }}</div>
                                </td>
                                <td class="px-6 py-4">
            ...
            @else
                <div class="text-center py-12">
                    ...
                    <h3 class="text-lg font-light text-black dark:text-white mb-2">No stock transactions yet</h3>
                    <p class="text-gray-600 text-sm mb-4">Start trading stocks to see your transaction history</p>
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mt-6">
            ...
            <div class="bg-card rounded-xl p-4 shadow-sm border border-border">
                <div class="flex items-center justify-between mb-3">
                    <div>
                        <p class="text-xs text-gray-500 dark:text-gray-300 mb-1">Total Buys</p>
                        <p class="text-lg font-light text-black">{{ $transactions->where('type', 'buy')->count() }}</p>
                    </div>
            ...
            <div class="bg-card rounded-xl p-4 shadow-sm border border-border">
                <div class="flex items-center justify-between mb-3">
                    <div>
                        <p class="text-xs text-gray-500 dark:text-gray-300 mb-1">Total Sells</p>
                        <p class="text-lg font-light text-black">{{ $transactions->where('type', 'sell')->count() }}</p>
                    </div>
                    <div class="w-8 h-8 flex items-center justify-center">
            ...
            <div class="bg-card rounded-xl p-4 shadow-sm border border-border">
                <div class="flex items-center justify-between mb-3">
                    <div>
                        ...
                        <p class="text-lg font-light text-black">{{ currency_symbol() }}{{ number_format($transactions->sum('total_amount'), 2) }}</p>
                    </div>
                    <div class="w-8 h-8 flex items-center justify-center">
            ...
            <div class="bg-card rounded-xl p-4 shadow-sm border border-border">
                <div class="flex items-center justify-between mb-3">
                    <div>
                        ...
                        <p class="text-lg font-light text-black">{{ currency_symbol() }}{{ number_format($transactions->sum('fee'), 2) }}</p>
                    </div>
                    <div class="w-8 h-8 flex items-center justify-center">
