            ...
            <div class="bg-card border border-border overflow-hidden rounded-lg">
                <form action="{{ route('admin.users.store') }}" method="POST" class="space-y-4">
                    ...
                    <div class="px-4 py-3 border-b border-border dark:border-gray-700 bg-muted/40">
                        ...
                        <p class="text-xs text-muted-foreground mt-1">Fill in the details for the new user account</p>
                    </div>
                        ...
                        <div>
                            ...
                            <div class="space-y-2">
                                <label class="flex items-center">
                                    ...
                                    <span class="ml-2 text-sm text-muted-foreground">Mark email as verified</span>
                                </label>
                                <p class="text-xs text-muted-foreground ml-6">
                                    If unchecked, the user will receive an email verification link.
                                </p>
                            </div>
                        </div>
