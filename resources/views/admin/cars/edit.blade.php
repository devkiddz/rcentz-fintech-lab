    ...
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <div class="flex space-x-2">
                <a href="{{ route('admin.cars.show', $car) }}" class="inline-flex items-center px-3 py-2 bg-muted text-muted-foreground text-sm font-medium rounded-lg hover:bg-gray-200 transition-all duration-200">
            ...
            <form action="{{ route('admin.cars.update', $car) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                    ...
                    <div class="p-4 space-y-4">
                        ...
                        <div>
                            ...
                            <textarea name="description" id="description" rows="4" 
                                      ...
                                      class="block w-full rounded-lg border-border shadow-sm focus:border-black focus:ring-black text-foreground placeholder-gray-400 @error('description') border-red-300 ring-red-300 @enderror">{{ old('description', $car->description) }}</textarea>
                            @error('description')
                                <p class="mt-2 text-xs text-red-600 flex items-center">
                                    <svg class="w-3 h-3 mr-1" fill="currentColor" viewBox="0 0 20 20">
                                        <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clip-rule="evenodd"></path>
                    ...
                    <div class="p-4 space-y-4">
                        ...
                        <div class="border-t border-border dark:border-gray-700 pt-4">
                            ...
                            <textarea name="image_urls" id="image_urls" rows="4" 
                                      ...
                                      class="block w-full rounded-lg border-border shadow-sm focus:border-black focus:ring-black text-foreground placeholder-gray-400">{{ old('image_urls', $car->images && is_array($car->images) ? implode("\n", array_filter($car->images, function($img) { return strpos($img, 'http') === 0; })) : '') }}</textarea>
                ...
                <div class="bg-card border border-border p-4 rounded-lg">
                    <div class="flex items-center justify-end space-x-3">
                        <a href="{{ route('admin.cars.show', $car) }}" class="inline-flex items-center px-4 py-2 bg-muted text-muted-foreground text-sm font-medium rounded-lg hover:bg-gray-200 transition-all duration-200">
                            Cancel
                        </a>
