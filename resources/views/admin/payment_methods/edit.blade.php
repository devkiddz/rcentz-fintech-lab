            ...
            <div class="bg-card border border-border overflow-hidden rounded-lg">
                <form action="{{ route('admin.payment_methods.update', $paymentMethod) }}" method="POST" enctype="multipart/form-data" class="space-y-4">
                    ...
                    <div class="px-4 py-3 border-b border-border dark:border-gray-700">
                        ...
                        <p class="text-xs text-muted-foreground mt-1">Update the details for this payment method</p>
                    </div>
                    ...
                    <div class="px-4 py-4 space-y-4">
                        ...
                        <div>
                            <label class="block text-xs font-medium text-muted-foreground mb-2">Current Logo</label>
                            <div class="flex items-center space-x-4">
                                <img src="{{ $paymentMethod->logo_url }}" 
                                     alt="{{ $paymentMethod->name }}" 
                                     class="w-12 h-12 object-contain rounded border border-border dark:border-gray-700">
                        ...
                        <!-- Logo Upload -->
                        <div>
                            <label for="logo" class="block text-xs font-medium text-muted-foreground mb-2">
                        ...
                        <div id="crypto-fields" class="space-y-4 p-4 bg-tesla-50 rounded-lg border border-tesla-200" style="display: {{ $paymentMethod->isCryptocurrency() ? 'block' : 'none' }};">
                            ...
                            <div>
                                <label class="block text-xs font-medium text-muted-foreground mb-2">Current QR Code</label>
                                <div class="flex items-center space-x-4">
                            ...
                            <div>
                                <label for="barcode" class="block text-xs font-medium text-muted-foreground mb-2">
