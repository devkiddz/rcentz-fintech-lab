                    ...
                    <div class="space-y-4">
                        ...
                        <div class="bg-card border border-border p-4 rounded-lg">
                            <div class="space-y-2">
                                ...
                                <a href="{{ route('admin.emails.index') }}" 
                                   class="w-full inline-flex items-center justify-center px-4 py-2 bg-muted text-muted-foreground text-sm font-medium rounded-lg hover:bg-muted transition-all duration-200">
                                    Cancel
                                </a>
                            </div>
                        </div>
