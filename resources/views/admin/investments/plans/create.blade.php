<x-admin-layout>
    ...
    <div class="py-6">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <form method="POST" action="{{ route('admin.investments.plans.store') }}" enctype="multipart/form-data" class="space-y-6">
                @csrf
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <select name="type" id="type" required
                                    ...
                                    <option value="tesla_focused" {{ old('type') == 'tesla_focused' ? 'selected' : '' }}>Tesla Focused</option>
                                    <option value="esg" {{ old('type') == 'esg' ? 'selected' : '' }}>ESG</option>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <select name="risk_level" id="risk_level" required
                                    ...
                                    <option value="very_high" {{ old('risk_level') == 'very_high' ? 'selected' : '' }}>Very High</option>
                                </select>
                                @error('risk_level')
                                    <p class="text-xs text-red-600 mt-1">{{ $message }}</p>
                                @enderror
                    ...
                    <div class="p-4 space-y-4">
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div>
                                ...
                                <input type="number" name="nav" id="nav" step="0.0001" value="{{ old('nav') }}" required
                                       class="w-full px-3 py-2 border border-border rounded-lg focus:ring-2 focus:ring-black focus:border-black transition-colors">
                                @error('nav')
                                    <p class="text-xs text-red-600 mt-1">{{ $message }}</p>
                                @enderror
                            ...
                            <div>
                                ...
                                <input type="number" name="minimum_investment" id="minimum_investment" step="0.01" value="{{ old('minimum_investment') }}" required
                                       class="w-full px-3 py-2 border border-border rounded-lg focus:ring-2 focus:ring-black focus:border-black transition-colors">
                            ...
                            <div>
                                ...
                                <input type="number" name="total_assets" id="total_assets" step="0.01" value="{{ old('total_assets') }}"
                                       class="w-full px-3 py-2 border border-border rounded-lg focus:ring-2 focus:ring-black focus:border-black transition-colors">
                                @error('total_assets')
                                    <p class="text-xs text-red-600 mt-1">{{ $message }}</p>
                                @enderror
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div>
                                ...
                                <input type="number" name="management_fee" id="management_fee" step="0.0001" value="{{ old('management_fee') }}" required
                                       class="w-full px-3 py-2 border border-border rounded-lg focus:ring-2 focus:ring-black focus:border-black transition-colors">
                            ...
                            <div>
                                ...
                                <input type="number" name="expense_ratio" id="expense_ratio" step="0.0001" value="{{ old('expense_ratio') }}" required
                                       class="w-full px-3 py-2 border border-border rounded-lg focus:ring-2 focus:ring-black focus:border-black transition-colors">
                            ...
                            <div>
                                ...
                                <input type="number" name="dividend_yield" id="dividend_yield" step="0.01" value="{{ old('dividend_yield') }}"
                                       class="w-full px-3 py-2 border border-border rounded-lg focus:ring-2 focus:ring-black focus:border-black transition-colors">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="number" name="previous_nav" id="previous_nav" step="0.0001" value="{{ old('previous_nav') }}"
                                       class="w-full px-3 py-2 border border-border rounded-lg focus:ring-2 focus:ring-black focus:border-black transition-colors">
                                @error('previous_nav')
                                    <p class="text-xs text-red-600 mt-1">{{ $message }}</p>
                                @enderror
                            ...
                            <div>
                                ...
                                <input type="date" name="inception_date" id="inception_date" value="{{ old('inception_date') }}" required
                                       class="w-full px-3 py-2 border border-border rounded-lg focus:ring-2 focus:ring-black focus:border-black transition-colors">
                    ...
                    <div class="p-4 space-y-4">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="url" name="prospectus_url" id="prospectus_url" value="{{ old('prospectus_url') }}"
                                       class="w-full px-3 py-2 border border-border rounded-lg focus:ring-2 focus:ring-black focus:border-black transition-colors">
                            ...
                            <div>
                                ...
                                <input type="url" name="fact_sheet_url" id="fact_sheet_url" value="{{ old('fact_sheet_url') }}"
                                       class="w-full px-3 py-2 border border-border rounded-lg focus:ring-2 focus:ring-black focus:border-black transition-colors">
                        ...
                        <div>
                            ...
                            <input type="file" name="image" id="image" accept="image/*"
                                   class="w-full px-3 py-2 border border-border rounded-lg focus:ring-2 focus:ring-black focus:border-black transition-colors">
                            <p class="text-xs text-muted-foreground mt-1">Upload an image for the investment plan (max 2MB)</p>
                            @error('image')
                                <p class="text-xs text-red-600 mt-1">{{ $message }}</p>
                            @enderror
                        </div>
