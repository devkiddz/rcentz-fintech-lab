...
{
    use HasFactory;
    protected $fillable=['copy_trader_profile_id','name','description','risk_level','minimum_allocation','recommended_allocation','is_public','is_active','use_manual_performance','manual_profit_loss','manual_return_percent','manual_performance_note','manual_performance_updated_by','manual_performance_updated_at'];
